<main>
        ...
        <div class="container-fluid">
            <div class="page-header-content pt-4">
                ...
                <div class="mb-1 font-weight-bold">
                    <h2><i class="fas fa-hand-holding-usd ml-2  mr-2 fa-lg fa-fw"></i>
                        Laporan Denda
                    </h2>
                </div>
            </div>
    ...
    <div class="container-fluid mt-n10">
        <div class="card mb-4">
            ...
            <div class="card-body">
                <div class="datatable">
                    <table class="table table-bordered table-hover" id="dataTableLaporanDenda" width="100%" cellspacing="0">
                        <thead>
                            <tr>
...
<script type="text/javascript">
    $(document).ready(function() {
        var table = $('#dataTableLaporanDenda').DataTable({
            ordering: false,
            "order": [
                [0, 'asc']
            ],
