<main>
        ...
        <div class="container-fluid">
            <div class="page-header-content pt-4">
                ...
                <div class="mb-1 font-weight-bold">
                    <h2><i class="fas fa-user-shield ml-2  mr-2 fa-lg fa-fw"></i>
                        Laporan Petugas
                    </h2>
                </div>
            </div>
    ...
    <div class="container-fluid mt-n10">
        <div class="card mb-4">
            ...
            <div class="card-body">
                <div class="datatable">
                    <table class="table table-bordered table-hover" id="dataTableLaporanPetugas" width="100%" cellspacing="0">
                        <thead>
                            <tr>
                                <th>Email Petugas</th>
                                <th>Nama Petugas</th>
                ...
                <div class="modal-dialog modal-dialog-centered modal-xl">
                    <div class="modal-content">
                        <div class="modal-header">
                            <h5 class="modal-title">Laporan Petugas</h5>
...
<script type="text/javascript">
    $(document).ready(function() {
        var table = $('#dataTableLaporanPetugas').DataTable({
            ordering: false,
            "order": [
                [0, 'asc']
            ],
