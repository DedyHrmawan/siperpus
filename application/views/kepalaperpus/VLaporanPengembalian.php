<main>
        ...
        <div class="container-fluid">
            <div class="page-header-content pt-4">
                ...
                <div class="mb-1 font-weight-bold">
                    <h2><i class="fas fa-people-arrows ml-2  mr-2 fa-lg fa-fw"></i>
    ...
    <div class="container-fluid mt-n10">
        <div class="card mb-4">
            ...
            <div class="card-body">
                <div class="datatable">
                    <table class="table table-bordered table-hover" id="dataTableLaporanPengembalian" width="100%" cellspacing="0">
                        <thead>
                            <tr>
                        ...
                        <tbody>
                            <tr>
                                <td>gordonramzi</td>
                                <td>06-07-2020</td>
                                <td>Buku dikembalikan dalam keadaan baik</td>
                            </tr>
                        </tbody>
                    </table>
                </div>
                ...
                <div class="modal-dialog modal-dialog-centered modal-xl">
                    <div class="modal-content">
                        <div class="modal-header">
                            <h5 class="modal-title">Laporan Pengembalian</h5>
...
<script type="text/javascript">
    $(document).ready(function() {
        var table = $('#dataTableLaporanPengembalian').DataTable({
            ordering: false,
            "order": [
                [0, 'asc']
            ],
